...
export class OrderBook extends ethereum.SmartContract {
  ...
  USDF_PRECISION(): BigInt {
    let result = super.call("USDF_PRECISION", "USDF_PRECISION():(uint256)", []);

    return result[0].toBigInt();
  }

  try_USDF_PRECISION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "USDF_PRECISION",
      "USDF_PRECISION():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getUsdfMinPrice(_otherToken: Address): BigInt {
    let result = super.call(
      "getUsdfMinPrice",
      "getUsdfMinPrice(address):(uint256)",
  ...
  try_getUsdfMinPrice(_otherToken: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getUsdfMinPrice",
      "getUsdfMinPrice(address):(uint256)",
      [ethereum.Value.fromAddress(_otherToken)],
