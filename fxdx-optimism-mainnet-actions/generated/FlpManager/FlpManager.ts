...
export class AddLiquidity__Params {
  ...
  get aumInUsdf(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }

  get flpSupply(): BigInt {
...
export class FlpManager extends ethereum.SmartContract {
  static bind(address: Address): FlpManager {
    return new FlpManager("FlpManager", address);
  }
  ...
  addLiquidity(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_minUsdf),
        ethereum.Value.fromUnsignedBigInt(_minFlp),
      ],
    );
  ...
  flp(): Address {
    let result = super.call("flp", "flp():(address)", []);

    return result[0].toAddress();
  }

  try_flp(): ethereum.CallResult<Address> {
    let result = super.tryCall("flp", "flp():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getAumInUsdf(maximise: boolean): BigInt {
    let result = super.call("getAumInUsdf", "getAumInUsdf(bool):(uint256)", [
      ethereum.Value.fromBoolean(maximise),
    ]);
  ...
  try_getAumInUsdf(maximise: boolean): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getAumInUsdf", "getAumInUsdf(bool):(uint256)", [
      ethereum.Value.fromBoolean(maximise),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  removeLiquidity(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_flpAmount),
